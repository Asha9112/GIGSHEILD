        ...
        <section className="claim-right-panel">
          ...
          <div className="claim-form-card">
            ...
            >
              ...
              <div className="claim-guidelines">
                ...
                <ul>
                  ...
                  <li>
                    Upload clear medical bills and reports.
                  </li>

                  <li>
                    Capture a live incident photo whenever possible.
                  </li>

                  <li>
                    Ensure the incident date is accurate.
                  </li>
                  ...
                  <li>
                    Claims are generally reviewed within 2–5 working days.
                  </li>
              ...
              <div className="claim-declaration">
                ...
                <label htmlFor="declaration">
                  ...
                  is true and correct. I understand that submitting
              ...
              <div className="claim-security">
                ...
                <p>
                  ...
                  encrypted. Only authorised GigShield claim
                  officers can access your submitted evidence.
